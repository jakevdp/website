...
\lfoot{
  ...
  \,\hfill {\footnotesize \textcolor{gray}{updated December 2016~~~~~}} \hfill\,
}
...
\smalltopic{Service}{}
   ...
   \subtopic[2013-2016]{PyCon}{
     Member of the tutorial review committee for PyCon 2013-2016.
   }
...
\smalltopic{Software}{}
   ...
   \subtopic[]{Others}{
     ...
     Matplotlib, IPython, NumPy, Pandas, AstroML, SciDB-Py, Pelican, and others.
     I have also open-sourced much of my research code and teaching materials.
	 More information is available in my \href{http://github.com/jakevdp}{GitHub profile}.
   }
