...
\lfoot{
  ...
  \,\hfill {\footnotesize \textcolor{gray}{updated November 2019~~~~~}} \hfill\,
}
...
\begin{minipage}[B]{0.5\textwidth}
	...
	{\Huge\bf\sf \color{deep_blue} J\huge \hskip -0.05cm AKE %
	 \Huge V\huge \hskip -0.05cm ANDER\Huge P\huge \hskip -0.05cm LAS}
	\\[-.1\baselineskip]
	{\bf\sf Software Engineer}
        \\
        {\bf\sf Open Source Developer}
        \\
        Google, Seattle WA
    }
\end{minipage}
...
\begin{center}
I build software tools for engineers, data scientists, and researchers.
\end{center}
...
\item[\mydot]
I am a software engineer at Google Research in Seattle, working on tools that support data-intensive research.
...
developing and presenting talks and tutorials on scientific computing
topics at various conferences in the data science world.
...
\smalltopic{Employment}{}
    ...
    \subtopic[2020--present]{Google}{
      Software Engineer, JAX Team\\
      Google Research, Bay Area}

    \subtopic[2018--2020]{Google}{
      Software Engineer, Colaboratory Team\\
      Google Research, Seattle}

    \subtopic[2018]{Google}{
      Visiting Researcher\\
      Google Research, Seattle}

    \subtopic[2017--2018]{UW eScience}{
      Director of Open Software \\
      University of Washington eScience Institute.}

    \subtopic[2014--2018]{UW eScience}{
      Senior Data Science Fellow \\
      University of Washington eScience Institute.}

    \subtopic[2014--2017]{UW eScience}{
...
\smalltopic{Volunteering}{}
    ...
    \subtopic[2007--2012]{Sierra Club}{
      ...
      program, I led 3-4 hiking \& camping trips each year with Seattle
      youth.
    }
...
\smalltopic{Formal Teaching}{}
    ...
    \subtopic[Fall 2017]{CSE 583}{
      Software Development for Data Scientists\\
      {\it University of Washington}}

    \subtopic[Winter \& Fall 2016]{CSE 599/ChemE 599}{
...
\smalltopic{Service}{}
  ...
  \subtopic[2018]{SciPy Conference}{
    Co-chair of the Data Science symposium at SciPy 2018.
  }

   \subtopic[2016-present]{Journal of Open Source Software}{
     Editor, Astronomy and Machine Learning
   }

   \subtopic[2014-2018]{Journal of Statistical Software}{
     Associate Editor, primarily focusing on submissions involving Python-language software.
   }

   \subtopic[2014-2017]{Astro Hack Week}{
     Creator of the annual Astro Hack Week conference series;
     sole organizer in 2014; co-organizer in 2015-2018. Since 2014, this model
     has been adapted by colleagues in other fields (including NeuroHackWeek
     and GeoHackWeek)
   }

   \subtopic[2017]{SciPy Conference}{
     Co-chair of the Astronomy \& Astrophysics symposium at SciPy 2017.
   }
   ...
   \subtopic[2013-2017]{PyCon}{
     Member of the tutorial review committee for PyCon 2013-2017.
   }

   \subtopic[2012-2016]{PyData}{
...
\smalltopic{Mentoring}{}
    ...
    \subtopic[2017-2018]{Callin Switzer}{
	  Postdoctoral Fellow, UW eScience Institute \& Biology Department
	}

    \subtopic[2017-2018]{Kathryn Neugent}{
	  Graduate Student, UW eScience Institute \& Astronomy Department
	}

    \subtopic[2015-2018]{David Fleming}{
	  Graduate Student, UW eScience Institute \& Astronomy Department
	}

    \subtopic[2015-2017]{Grace Telford}{
      Graduate Student, UW eScience Institute \& Astronomy Department
    }

    \subtopic[2015-2016]{Jes Ford}{
      Postdoctoral Fellow, UW eScience Institute \& Astronomy Department
    }

    \subtopic[2015-2017]{Xiaofeng Meng}{
      Postdoctoral Fellow, UW eScience Institute \& Earth and Space Sciences
    }
...
\topic{A \large\hskip -1ex WARDS \& HONORS}{~}
    ...
    \subtopic[2017-2018]{DIRAC Institute}{
      Named {\it DIRAC Fellow} at the UW Data Intensive Research in Astronomy and Cosmology (DIRAC) Institute
    }

    \subtopic[July 2016]{International Astrostatistics Association}{
      Winner of the 2016 {\it Outstanding Publication in Astrostatistics} award
      for {\it Statistics, Data Mining, and Machine Learning in Astronomy}
      (With Z. Ivezic, A. Connolly, and A. Gray)
    }

    \subtopic[November 2015]{Data Analysis Contest}{
      Winner of ``Most Insightful'' analysis in the 2015 Pronto Cycle Share Data Challenge
    }

    \subtopic[2014-Present]{Data Science}{
      Named {\it Senior Data Science Fellow} at the UW eScience Institute
    }
    ...
    \subtopic[1999-2003]{Calvin College}{
      ...
      4 years on MIAA Atheletic Honor Roll;
...
\topic{S \large\hskip -1ex ELECTED TALKS}{{\small \\{\textcolor{gray}{\it $**$= invited talk}}}\\
    Many of the slide-decks referenced below are archived at \url{http://speakerdeck.com/jakevdp/}.}

\smalltopic{Keynote Addresses}{}

  \dateonly[**October 2019]{
    {\it Python's Journey to Data Science}\\
    PyCon India 2019, Chennai, India
  }

  \dateonly[**April 2019]{
    {\it A Survey of the Pydata Stack}\\
    PyCon Colombia 2019, Bogota, Colombia
  }

  \dateonly[**July 2017]{
     {\it PyData 101: Everything you need to know to get started with data science in Python}\\
     PyData Seattle 2017
  }

  \dateonly[**May 2017]{
     {\it The Unexpected Effectiveness of Python in Science}\\
     PyCon 2017, Portland OR
  }

  \dateonly[**July 2015]{
    {\it The State of the Stack}\\
...
\smalltopic{Computing}{}
  ...
  \dateonly[July 2020]{
    {\it JAX: Accelerated Machine Leaning Research}\\
    SciPy 2020, Virtual
  }
...
\smalltopic{Astronomy}{}
  ...
  \dateonly[**August 2017]{
    {\it Statistics, Data Mining, and Machine Learning (don't really work) in Astronomy}\\
    Plenary session at the 18th International Workshop on Advanced Computing and Analysis Techniques in Physics Research (ACAT 2017)
  }
...
\smalltopic{Academia \& Policy}{}
  ...
  \dateonly[**December 2016]{
    {\it Promoting Open Science in the University}\\
    Invited Panel, Open Science and Big Data session at IEEE 2016, Washington DC
  }
...
\smalltopic{Books}{
  \begin{itemize}[leftmargin=0ex, itemsep=0ex, labelindent=-4ex, parsep=.5ex]
    ...
    \publication J. VanderPlas.
      \href{http://shop.oreilly.com/product/0636920034919.do}{\sl The Python Data Science Handbook.}
      O'Reilly Media, 2016
    \publication J. VanderPlas.
      \href{http://www.oreilly.com/programming/free/a-whirlwind-tour-of-python.csp}{\sl A Whirlwind Tour of Python.}
      O'Reilly Media, 2016
    \publication Z. Ivezic, A. Connolly, J. VanderPlas \& A. Gray.\\
       \href{http://press.princeton.edu/titles/10159.html}{\sl Statistics, Data Mining and Machine Learning in Astronomy.}
      Princeton University Press, 2014\\
      {\bf (Winner of the IAA's
        {\it \bf Outstanding Publication in Astrostatistics} award)}
  \end{itemize}
}
