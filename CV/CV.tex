...
\begin{center}
My driving goal is to encourage and support the use of reproducible software
practices for across disciplines.
\end{center}
...
{\it Scikit-Learn}, {\it SciPy}, {\it AstroPy}, and many others.

\item[\mydot]
Outside the university, I spend significant time
...
\smalltopic{Service}{}
   ...
   \subtopic[2014-2017]{AstroHackWeek}{
     Creator and lead organizer for the first annual AstroHackWeek in 2014;
     co-organizer in years since.
   }
...
\smalltopic{Computing}{}
  ...
  \dateonly[**July 2017]{
     {\it {\bf Keynote: PyData 101}}\\
     PyData Seattle 2017
  }

  \dateonly[**May 2017]{
     {\it {\bf Keynote: The Unexpected Effectiveness of Python in Science}}\\
