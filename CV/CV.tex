...
\lfoot{
  ...
  \,\hfill {\footnotesize \textcolor{gray}{modified August 2013~~~~~}} \hfill\,
}
...
Cosmology, weak lensing, data mining and automated learning algorithms in large astronomical data sets.
...
\smalltopic{General Audience}{}
  ...
  \dateonly[*March 2011]{
    ...
    Pacific Science Center's ``Science with a Twist''
  }

  \dateonly[*February 2011]{
    {\it Interconnection in Art and Cosmology}\\
    University of Washington Astronomy-themed art show
  }
