...
data mining and automated learning algorithms in large astronomical data sets.
...
tools (primarily in the Python programming language) and encouraging open \&
reproducible research through these tools.
...
\smalltopic{Employment}{}
    ...
    \subtopic[2004--2006]{Mount Hermon}{
      Experiential Science Educator (students: 4th-8th grade)\\
...
\smalltopic{Skills}{
  ...
  \begin{itemize}[leftmargin=0ex, itemsep=0ex, labelindent=-2ex, parsep=.5ex]
    ...
    \item[\mydot] Familiarity with a variety of tools and languages, including
      bash, csh, \LaTeX{}, html, git, various database query languages,
      web templating enginces such as Jinja, etc.
    \item[\mydot] Author of the blog {\it Pythonic Perambulations}, which
      covers scientific computing, visualization, and whimsical distractions:
...
\smalltopic{Software}{}
   ...
   \subtopic[]{Et Cetera}{
     ...
     IPython for interactive computing, and Pelican for static blog generation.
   }
...
\smalltopic{Computing Talks \& Tutorials}{}
  ...
  \dateonly[October 2012]{
    ...
    PyData NYC, New York NY (invited)
  }
  \dateonly[July 2012]{
    {\it Machine Learning in Python}\\
    Scipy 2012, Austin TX
  }
  \dateonly[March 2012]{
    {\it Scikit-Learn Tutorial}\\
    PyData Workshop, Google Campus, Mountain View CA (invited)
  }
...
\smalltopic{General Audience}{}
  ...
  \dateonly[June 2013]{
    ...
    Seattle International Film Festival (invited)
  }
